...
class InfoPlaygroud extends StatelessWidget {
  const InfoPlaygroud({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  children: const [
                    CustomCardPlaygroud(text1: '1', text2: '01'),
                    SizedBox(height: 8),
                    CustomCardPlaygroud(text1: '2', text2: '02'),
                    SizedBox(height: 8),
                    CustomCardPlaygroud(text1: '3', text2: '03'),
                    SizedBox(height: 8),
                    CustomCardPlaygroud(text1: '4', text2: '04'),
                  ],
                ),
              ),
            ],
...
class CustomCardPlaygroud extends StatelessWidget {
  const CustomCardPlaygroud(

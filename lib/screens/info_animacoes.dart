...
class InfoAnimacoes extends StatelessWidget {
  const InfoAnimacoes({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  children: const [
                    CustomCardAnimacoes(text1: '1', text2: '01'),
                    SizedBox(height: 8),
                    CustomCardAnimacoes(text1: '2', text2: '02'),
                    SizedBox(height: 8),
                    CustomCardAnimacoes(text1: '3', text2: '03'),
                    SizedBox(height: 8),
                    CustomCardAnimacoes(text1: '4', text2: '04'),
                  ],
                ),
              ),
            ],
...
class CustomCardAnimacoes extends StatelessWidget {
  const CustomCardAnimacoes(
